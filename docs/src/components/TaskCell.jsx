...
export default function TaskCell(props){
    return(
        <div className="w-[80%] min-h-[80px] bg-orange-300 rounded-[20px] mt-[100px] shadow-button p-[10px] dark:bg-[#8687E7] animate-drop-down transition-all duration-500 flex flex-col">
